...
namespace FurniturServiceView
{
    public partial class FormFurnitureComponent : Form
    {
        ...
        public int Id { get => Convert.ToInt32(comboBoxComponent.SelectedValue); set => comboBoxComponent.SelectedValue = value; }
        public string ComponentName => comboBoxComponent.Text;

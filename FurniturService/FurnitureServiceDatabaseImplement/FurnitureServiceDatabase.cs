...
namespace FurnitureServiceDatabaseImplement
{
    public class FurnitureServiceDatabase : DbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=FurnitureServiceDatabase3H;Integrated Security=True;MultipleActiveResultSets=True;");
            }
